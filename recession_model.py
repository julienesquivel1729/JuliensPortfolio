...
# Define final fine-tuned parameter grid for LightGBM
param_grid = {
    "num_leaves": [40],  # Increased from 31 → 40 for more decision power
    "learning_rate": [0.03],  # Slower learning rate for better precision
    "n_estimators": [300],  # More boosting rounds to refine predictions
    "class_weight": ["balanced"]  # Keeps recall strong
}
...
print("🔄 Running Final LightGBM Optimization... This may take a few minutes.")
...
print("\n🔍 Best Hyperparameters Used:", param_grid)
